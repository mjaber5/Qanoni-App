...
import 'contract_input_form_property.dart';
...
class AceprtProperty extends StatefulWidget {
  ...
  @override
  State<AceprtProperty> createState() => _EquipmentAcepetState();
}

class _EquipmentAcepetState extends State<AceprtProperty> {
  bool _agreed = false;
                    ...
                    onPressed: _agreed
                        ? () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const ContractInputFormProperty(), // Ensure the class name is correct
                              ),
                            );
                          }
