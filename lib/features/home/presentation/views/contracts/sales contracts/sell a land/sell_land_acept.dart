...
import 'contract_input_form_land.dart';
...
class SellLandAcept extends StatefulWidget {
  ...
  @override
  State<SellLandAcept> createState() => _EquipmentAcepetState();
}

class _EquipmentAcepetState extends State<SellLandAcept> {
  bool _agreed = false;
                    ...
                    onPressed: _agreed
                        ? () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const ContractInputFormLand(), // Ensure the class name is correct
                              ),
                            );
                          }
