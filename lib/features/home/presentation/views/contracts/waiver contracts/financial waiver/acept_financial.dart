...
class AceptFinancial extends StatefulWidget {
  ...
  @override
  State<AceptFinancial> createState() => _AceaptPageState();
}

class _AceaptPageState extends State<AceptFinancial> {
  bool _agreed = false;
              ...
              child: SingleChildScrollView(
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      localizations.business_partnership_waiver_terms,
                      style: TextStyle(
                        fontSize: 18.0,
                    ...
                    onPressed: _agreed
                        ? () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    const ContractInputFormWaiverLegalFinancialArabic(),
                              ),
                            );
                          }
                        : null,
